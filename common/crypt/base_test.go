...
func TestB(t *testing.T) {
	phoneArray := []string{
		"{cpt}MTg2Njg2MzAxMTMFBQUFBZkkHbObkiUsxp9SzS3nDPg=",
		"{cpt}MTU2NzczMzkyMzgFBQUFBZkkHbObkiUsxp9SzS3nDPg=",
		"{cpt}MTg2Njg2MzAxMTMFBQUFBZkkHbObkiUsxp9SzS3nDPg=",
		"{cpt}MTU2NzczMzkyMzgFBQUFBZkkHbObkiUsxp9SzS3nDPg=",
		"{cpt}MTMzMTg5NDgyMjcFBQUFBZkkHbObkiUsxp9SzS3nDPg=",
		"{cpt}MTc3MTA1ODg1NzIFBQUFBZkkHbObkiUsxp9SzS3nDPg=",
		"{cpt}MTc4MDQwODIxMTcFBQUFBZkkHbObkiUsxp9SzS3nDPg=",
	}
...
func TestNull(t *testing.T) {
	pemBlock, err := pem.Decode([]byte(""))
	fmt.Println(err, "==============", pemBlock)
	base64.StdEncoding.EncodeToString(pemBlock.Bytes)
}
